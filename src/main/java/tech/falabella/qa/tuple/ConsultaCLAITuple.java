    ...
    public static final Function<ResultSet, ConsultaCLAITuple> sqlMap = (resultSet) -> {
        try {
            return ConsultaCLAITuple.builder()
                    .validacion(resultSet.getString(0))
                    .numeroAutorizacion(resultSet.getString(1))
                    .tarjeta(resultSet.getString(2))
                    .cuenta(resultSet.getString(3))
                    .codigoTransaccionAdquiriente(resultSet.getString(4))
                    .valorOriginal(resultSet.getString(5))
                    .ultimoPaso(resultSet.getString(6))
                    .codigoRespuestaAdquiriente(resultSet.getString(7))
                    .fechaFinal(resultSet.getString(8))
                    .redAdquiriente(resultSet.getString(9))
                    .secuencia(resultSet.getString(10))
                    .autOriginal(resultSet.getString(11))
                    .fechaRegistroEncabezado(resultSet.getString(12))
                    .fechaRegistroDetalle(resultSet.getString(13))
                    .montoImpIVA(resultSet.getString(14))
                    .montoBaseIVA(resultSet.getString(15))
                    .propina(resultSet.getString(16))
                    .terminal(resultSet.getString(17))
                    .marcaPignoracion(resultSet.getString(18))
                    .marcaInternacional(resultSet.getString(19))
                    .numeroCuotas(resultSet.getString(20))
                    .comercio(resultSet.getString(21))
                    .build();
